...
- `DEFAULT_PROVIDER`: Default provider to use when none specified. Possible value: `'anikoto'`.
...
This README reflects the modular API with Anikoto support, keeping the same structure as the original but updated with:

- Modular provider architecture
- Anikoto provider documentation
- Unified HLS streaming source building
- Optimized Vercel/Node.js dual deployment support
